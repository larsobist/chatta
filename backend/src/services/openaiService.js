...
const initializeMessageHistory = (language) => {
    ...
    messageHistory.push({
        ...
        options, and fulfilling requests. You can help with any related queries. The functions you can and must perform include:
        ...
        (e.g., 10:00). If a user provides a time like "8" or "8:00," automatically transform it to "08:00".
        ...
        5. get_available_rooms: List all rooms available to the user. Ask if he wants to filter if no filter is given like equipment (Monitor)
        All outputs must be in plain text only. Do not use any markdown formatting, such as **, bullet points (-) 
        ...
        them to provide a valid time slot. When a request like creating a booking, updating, or deleting, send a validation message. 
        Once the information is confirmed, call the function. If a user asks about anything outside the scope of room-related information, gently 
    ...
    const tools = [
        {
            ...
            function: {
                name: "find_booking",
                description: "Find a reservation with the given params or show all when no params are given. Ask first if he wants to look for all or wants to filter.",
                parameters: {
                    type: "object",
                    properties: {
                        date: { type: "string", description: "The date of the booking, e.g., 2024-06-26" },
                        timeSlot: { type: "string", description: "The time of the booking, e.g., 11:00 or 11, always transform to HH:00 format" },
        ...
        },
        {
            ...
            function: {
                name: "create_booking",
                description: "Create a reservation with the params date and timeslot, after receiving that input, ask if they want a specific room based on the roomnumber or equipment. Only allow bookings at full hours and parse them to the right format (9 and 9:00 should be converted to 09:00). And return an answer with all booking values (Date, Time, Roomnumber, Equipment)",
                parameters: {
                    type: "object",
                    properties: {
                        roomNumber: { type: "string", description: "The room number for the booking" },
        ...
        },
        {
            ...
            function: {
                ...
                parameters: {
                    type: "object",
                    properties: {
                        roomNumber: { type: "string", description: "The room number of the booking, e.g., 100" },
                        date: { type: "string", description: "The date of the booking, e.g., 2024-09-23" },
                        timeSlot: { type: "string", description: "The time of the booking, e.g., 11:00 or 11, always transform to HH:00 format" },
                    },
            ...
            function: {
                ...
                parameters: {
                    ...
                    properties: {
                        ...
                        timeSlot: { type: "string", description: "The time of the booking, e.g., 11:00 or 11, always transform to HH:00 format" },
                        new_roomNumber: { type: "string", description: "The updated room number of the booking, e.g., 100" },
                        new_date: { type: "string", description: "The updated date of the booking, e.g., 2024-06-27" },
                        new_timeSlot: { type: "string", description: "The updated time of the booking, e.g., 12:00 or 12, always transform to HH:00 format" }
                    },
        ...
        },
        {
            ...
            function: {
                ...
                description: "List all rooms available to the user, before executing the function ask if he wants to filter if he hasnt specified a filter. Return all Room Data such as Roomnumber etc.",
                parameters: {
                    type: "object",
                    properties: {
                        date: { type: "string", description: "The current date of the booking, e.g., 2024-06-26" },
